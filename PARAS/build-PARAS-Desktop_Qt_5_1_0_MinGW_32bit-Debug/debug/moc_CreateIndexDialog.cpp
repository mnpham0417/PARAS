...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_CreateIndexDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 58, 11)
    ...
    "GetInputFile\0GetOutputFile\0ShowPreview\0"
};
...
const QMetaObject CreateIndexDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_CreateIndexDialog.data,
      qt_meta_data_CreateIndexDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CreateIndexDialog.stringdata))
