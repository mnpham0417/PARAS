			   ...
			   const unsigned long size_threshold )
{
	 ...
	 struct timeval tim1;
	       ...
	       double f1=tim1.tv_sec+(tim1.tv_usec/1000000.0);
...
//      getchar();
   ...
   gettimeofday(&tim1, NULL);
     double f2=tim1.tv_sec+(tim1.tv_usec/1000000.0);
     printf("frequent Itemsets mining: %.6lf seconds elapsed\n", f2-f1);
   ...
   printf("rule generation: %.6lf seconds elapsed\n", t2-t1);
