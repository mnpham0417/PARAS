...
#include "../src/graphical/ruleview/singlerule/FilterCompleter.hpp"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_PARASProgram__Graphical__FilterCompleter_t, stringdata) + ofs \
...
QT_MOC_LITERAL(0, 0, 40)
    ...
    "PARASProgram::Graphical::FilterCompleter\0"
};
...
const QMetaObject PARASProgram::Graphical::FilterCompleter::staticMetaObject = {
    { &QCompleter::staticMetaObject, qt_meta_stringdata_PARASProgram__Graphical__FilterCompleter.data,
      qt_meta_data_PARASProgram__Graphical__FilterCompleter,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PARASProgram__Graphical__FilterCompleter.stringdata))
        return static_cast<void*>(const_cast< FilterCompleter*>(this));
