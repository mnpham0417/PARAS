...
#include "../src/graphical/ruleview/singlerule/glyph/GlyphView.hpp"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_PARASProgram__Graphical__GlyphView_t, stringdata) + ofs \
...
void PARASProgram::Graphical::GlyphView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        GlyphView *_t = static_cast<GlyphView *>(_o);
        switch (_id) {
...
const QMetaObject PARASProgram::Graphical::GlyphView::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_PARASProgram__Graphical__GlyphView.data,
      qt_meta_data_PARASProgram__Graphical__GlyphView,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PARASProgram__Graphical__GlyphView.stringdata))
        return static_cast<void*>(const_cast< GlyphView*>(this));
