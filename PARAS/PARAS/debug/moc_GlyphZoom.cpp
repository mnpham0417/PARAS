...
#include "../src/graphical/ruleview/singlerule/glyph/GlyphZoom.hpp"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_PARASProgram__Graphical__GlyphZoom_t, stringdata) + ofs \
...
QT_MOC_LITERAL(0, 0, 34)
    ...
    "PARASProgram::Graphical::GlyphZoom\0"
};
...
const QMetaObject PARASProgram::Graphical::GlyphZoom::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_PARASProgram__Graphical__GlyphZoom.data,
      qt_meta_data_PARASProgram__Graphical__GlyphZoom,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PARASProgram__Graphical__GlyphZoom.stringdata))
