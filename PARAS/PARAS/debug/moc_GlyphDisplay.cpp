...
#include "../src/graphical/ruleview/singlerule/glyph/GlyphDisplay.hpp"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_PARASProgram__Graphical__GlyphDisplay_t, stringdata) + ofs \
...
QT_MOC_LITERAL(0, 0, 37)
    ...
    "PARASProgram::Graphical::GlyphDisplay\0"
};
...
const QMetaObject PARASProgram::Graphical::GlyphDisplay::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_PARASProgram__Graphical__GlyphDisplay.data,
      qt_meta_data_PARASProgram__Graphical__GlyphDisplay,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PARASProgram__Graphical__GlyphDisplay.stringdata))
        return static_cast<void*>(const_cast< GlyphDisplay*>(this));
