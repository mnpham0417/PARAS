...
#include "../src/graphical/ruleview/singlerule/SingleView.hpp"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_PARASProgram__Graphical__SingleView_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 95, 13)
    ...
    "QAbstractButton*\0clickedButton\0"
};
...
const QMetaObject PARASProgram::Graphical::SingleView::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_PARASProgram__Graphical__SingleView.data,
      qt_meta_data_PARASProgram__Graphical__SingleView,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PARASProgram__Graphical__SingleView.stringdata))
        return static_cast<void*>(const_cast< SingleView*>(this));
    if (!strcmp(_clname, "EventListener"))
        return static_cast< EventListener*>(const_cast< SingleView*>(this));
